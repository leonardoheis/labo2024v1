...
TS_strategy_guantesblancos_202107 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$future <- c(202107)
  param_local$final_train <- c(2202105, 202104, 202103, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903, 201902, 201901)
...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$bo_iteraciones <- 100 #15 # iteraciones de la Optimizacion Bayesiana
